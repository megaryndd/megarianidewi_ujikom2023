			...
			<table border="3" class="responsive-table striped highlight">
				...
				<?php 
					...
					<tr>
						...
						<td>
							<a class="btn red modal-trigger" href="#tanggapan&id_pengaduan=<?php echo $r['id_pengaduan'] ?>">More</a> 
							<a class="btn blue" onclick="return confirm('Anda Yakin Ingin Menghapus Laporan?')" href="index.php?p=pengaduan_hapus&id_pengaduan=<?php echo $r['id_pengaduan'] ?>">Hapus</a></td>
